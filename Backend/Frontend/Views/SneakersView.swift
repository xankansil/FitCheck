...
struct SneakersView: View {
    ...
    @State private var sneakers = [ClothingItem]()
            ...
            if(userInfo!.id != nil) {
                ...
                ScrollView{
                    ...
                    do {
                        ...
                        let query = closet.whereField("clothing", isEqualTo: "sneakers")
                        sneakers = try await UserManager.shared.getClothingItems(userID: userInfo!.id!, query: query)
                    } catch {
                        sneakers = []
