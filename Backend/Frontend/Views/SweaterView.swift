...
struct SweaterView: View {
    ...
    @State private var sweaters = [ClothingItem]()
            ...
            if(userInfo!.id != nil) {
                ...
                ScrollView{
                    ...
                    VStack(alignment: .leading, spacing: 20){
                        ...
                        // .scaledToFit()
                        ForEach(sweaters, id:\.id) { item in
                            if (item.img_url != nil){
                    ...
                    do {
                        ...
                        sweaters = try await UserManager.shared.getClothingItems(userID: userInfo!.id!, query: query)
                    } catch {
                        sweaters = []
                        print("error loading data in short sleeve view")
                    }
                }.navigationTitle("My Sweaters")
            }
        } else {
